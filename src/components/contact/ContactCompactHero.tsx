    ...
    <section className="bg-stakerpol-navy text-white">
      <div className="container-custom py-10 px-4 md:px-8">
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-2 mt-4">
          {badges.map(b => (
            <div key={b} className="flex items-center gap-1.5 text-sm text-white/90">
        ...
        <div className="flex flex-col sm:flex-row gap-2 mt-6">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg border-2 border-white/50 hover:border-white hover:bg-white/10 text-white font-semibold text-sm min-h-[44px] transition-colors"
          >
            <Send size={16} />
            Wyślij zapytanie
          </a>
