    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-3">
          <div className="w-10 h-10 rounded-full bg-stakerpol-navy/10 flex items-center justify-center flex-shrink-0">
            <Phone className="text-stakerpol-navy" size={18} />
          </div>
          <div className="min-w-0">
            <div className="text-[11px] font-semibold uppercase tracking-wider text-gray-500">Telefon</div>
            <a href="tel:+48694133592" className="text-stakerpol-navy font-bold text-lg hover:underline">694 133 592</a>
        ...
        <div className="flex items-start gap-3">
          <div className="w-10 h-10 rounded-full bg-stakerpol-navy/10 flex items-center justify-center flex-shrink-0">
            <Mail className="text-stakerpol-navy" size={18} />
          </div>
          <div className="min-w-0">
            <div className="text-[11px] font-semibold uppercase tracking-wider text-gray-500">E-mail</div>
            <a href="mailto:info@stakerpol.pl" className="text-stakerpol-navy font-semibold hover:underline break-all">info@stakerpol.pl</a>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <a href="https://wa.me/48694133592" target="_blank" rel="noopener noreferrer" className="text-stakerpol-navy font-semibold hover:underline">694 133 592</a>
          </div>
        </div>

        <div className="flex items-start gap-3">
          <div className="w-10 h-10 rounded-full bg-stakerpol-navy/10 flex items-center justify-center flex-shrink-0">
            <Clock className="text-stakerpol-navy" size={18} />
          </div>
          <div>
            <div className="text-[11px] font-semibold uppercase tracking-wider text-gray-500">Godziny pracy</div>
            <div className="font-semibold text-stakerpol-navy">Pon–Pt, 8:00–17:00</div>
          </div>
        </div>
      </div>
