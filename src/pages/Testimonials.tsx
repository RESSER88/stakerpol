          ...
          <div className="mb-12 animate-fade-in delay-150">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 max-w-4xl mx-auto">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="text-4xl font-bold text-stakerpol-navy">5.0</div>
                <div className="text-sm text-muted-foreground mt-1">{strip.rating}</div>
              </div>
              <div className="flex flex-col items-center text-center">
                <Users className="w-7 h-7 text-stakerpol-navy mb-2" />
                <div className="text-4xl font-bold text-stakerpol-navy">850+</div>
                <div className="text-sm text-muted-foreground mt-1">{strip.sold}</div>
              </div>
              <div className="flex flex-col items-center text-center">
                <Award className="w-7 h-7 text-stakerpol-navy mb-2" />
                <div className="text-4xl font-bold text-stakerpol-navy">{strip.yearsValue}</div>
                <div className="text-sm text-muted-foreground mt-1">{strip.years}</div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-stakerpol-navy text-white py-16">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in">
            ...
            <Button className="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 md:py-3 px-4 md:px-6 rounded-md transition-all duration-300 inline-flex items-center justify-center shadow-md hover:shadow-lg transform hover:-translate-y-1 text-sm md:text-base" size="lg" asChild>
