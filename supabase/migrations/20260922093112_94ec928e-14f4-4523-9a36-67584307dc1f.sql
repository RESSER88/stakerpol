CREATE OR REPLACE FUNCTION public.create_offer(_token text, _filters jsonb, _nazwa text, _telefon text DEFAULT NULL::text, _email text DEFAULT NULL::text, _tygodnie integer DEFAULT 2, _notatka text DEFAULT NULL::text, _kanal text DEFAULT NULL::text, _renewed_from uuid DEFAULT NULL::uuid, _firma text DEFAULT NULL::text, _kanal_detail text DEFAULT NULL::text)
...
REVOKE ALL ON FUNCTION public.create_offer(text, jsonb, text, text, text, integer, text, text, uuid, text, text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.create_offer(text, jsonb, text, text, text, integer, text, text, uuid, text, text) FROM anon;
GRANT EXECUTE ON FUNCTION public.create_offer(text, jsonb, text, text, text, integer, text, text, uuid, text, text) TO authenticated;